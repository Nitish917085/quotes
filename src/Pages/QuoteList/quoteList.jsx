                ...
                quotes.length ? (
                  quotes.map((quote,index) => (
                    <div className="card" key={index}>
                      <div className="img-container" style={{ backgroundImage: `url(${quote.mediaUrl})` }}>
                        {quote.mediaUrl ? (
                          <img
                            src={quote.mediaUrl}
                            alt="Quote visual"
                            onError={() => setQuotes(prev =>
                              prev.map(q => q.id === quote.id ? { ...q, imageError: true } : q)
                            )}
                          />
                        ) : (
                        ...
                        <div className="text_overlay">
                          ...
                          <div className="time-card">createdAt : {quote.createdAt}</div>
                        </div>
                      </div>
                    </div>
                  ))
